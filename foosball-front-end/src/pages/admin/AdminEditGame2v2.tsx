                ...
                <div className="row">
                    <div className="left">
                        ...
                        <label>
                            ...
                            <input required disabled type="text" maxLength={255} placeholder="Username"
                                   defaultValue={redTeam}/>
                        </label>
                        <label>
                            Points
                            <input required type="number" max="10" min="0" step="1" placeholder="Points"
                                   defaultValue={redScore} onChange={e => setRedScore(parseInt(e.target.value))}/>
                        </label>
                    </div>
                    <div>
                    ...
                    <div className="right">
                        ...
                        <label>
                            Points
                            <input required type="number" max="10" min="0" step="1" placeholder="Points"
                                   defaultValue={blueScore} onChange={e => setBlueScore(parseInt(e.target.value))}/>
                        </label>
                    </div>
                </div>
                {error()}
