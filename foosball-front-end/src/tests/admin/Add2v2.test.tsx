...
function addGame() {
    ...
    fireEvent.change(screen.getAllByPlaceholderText(/Username/i)[2], {target: {value: `${username}3`}});
    fireEvent.change(screen.getAllByPlaceholderText(/Username/i)[3], {target: {value: `${username}4`}});
